<?php /*a:3:{s:75:"G:\phpStudy\PHPTutorial\WWW\tp5\application\index\view\project\project.html";i:1534856518;s:73:"G:\phpStudy\PHPTutorial\WWW\tp5\application\index\view\common\header.html";i:1534251106;s:73:"G:\phpStudy\PHPTutorial\WWW\tp5\application\index\view\common\footer.html";i:1533990931;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
            ...
            <?php if(is_array($project) || $project instanceof \think\Collection || $project instanceof \think\Paginator): $i = 0; $__LIST__ = $project;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
              <li>
                <div class="card-front">
                  <div class="text2"><?php echo htmlentities($vo['ProjectName']); ?></div>
                  <p><?php echo htmlentities($vo['ProjectInfo']); ?></p>
                </div>
                <div class="card-back">
                ...
                <div class="all-content">
                  <div class="text2"><?php echo htmlentities($vo['ProjectName']); ?></div>
                  <p><?php echo htmlentities($vo['ProjectInfo']); ?></p>
                  <img src="http://127.0.0.1/tp5/public/static/projfile/<?php echo htmlentities($vo['Pic']); ?>" alt="<?php echo htmlentities($vo['Alt']); ?>">
                  <p><?php echo htmlentities($vo['Alt']); ?></p>
                  <p><a href="../http://127.0.0.1/tp5/public/static/uploads/<?php echo htmlentities($vo['Finfile']); ?>" style="color:#2673b4;text-decoration:underline;" download="http://127.0.0.1/tp5/public/static/uploads/<?php echo htmlentities($vo['Finfile']); ?>">项目详情</a></p>
                </div>
              </li>
