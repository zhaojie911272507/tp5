<?php /*a:1:{s:82:"G:\phpStudy\PHPTutorial\WWW\tp5\application\member\view\member\finlistproject.html";i:1534773935;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<div class="panel admin-panel">
  ...
  <div class="padding border-bottom">
      <ul class="search">
        <li>
          <a class="button border-blue" href="<?php echo url('member/listproject'); ?>"><span class="icon-reply"></span>返回</a>
        </li>
      </ul>
    </div>
